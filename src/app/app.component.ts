...
export class AppComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.gears.push(Gear.connectionGear(180, this.gears[11], Angle.fromDegree(0)))
        this.gears.push(Gear.attachedGear(20, this.gears[12]))
        this.gears.push(Gear.connectionGear(40, this.gears[13], Angle.fromDegree(0)))

        // bridge second 
        this.gears.push(Gear.connectionGear(220, this.gears[secondHandIndex], Angle.fromDegree(45)))
        this.gears.push(Gear.connectionGear(220, this.gears[15], Angle.fromDegree(0)))
        this.gears.push(Gear.connectionGear(50, this.gears[16], Angle.fromDegree(-15)))
        this.gears.push(Gear.constrainedGear(this.gears[17], this.gears[1], 90))

        // bridge minute 
        this.gears.push(Gear.connectionGear(200, this.gears[minuteHandIndex], Angle.fromDegree(-55)))
        this.gears.push(Gear.connectionGear(80, this.gears[19], Angle.fromDegree(-10)))
        this.gears.push(Gear.constrainedGear(this.gears[20], this.gears[2], 140))

        // bridge hour 
        this.gears.push(Gear.constrainedGear(this.gears[hourHandIndex], this.gears[3], 180))
